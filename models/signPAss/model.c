...
#include "n64_defs.h"
#include "gtHelpers.h"
extern Object2639 SignPass_Obj;
Object2639 *SignPass_objp = &SignPass_Obj;
static
...
gtTriN SignPass_tris_0[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {3, 4, 5, 0},
    {6, 7, 8, 0}, {9, 10, 11, 0},
...
gtTriN SignPass_tris_1[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
...
gtTriN SignPass_tris_2[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignPass_tris_3[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignPass_tris_4[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {6, 7, 4, 0},
    {6, 8, 7, 0}, {7, 9, 4, 0},
...
gtTriN SignPass_tris_5[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignPass_tris_6[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtGfx SignPass_GfxList[] = {
    ...
    {
        NULL,
        (gtState *)&SignPass_StateL_0,
        sign_Cube_mesh_vtx_0+64,
        SignPass_tris_1,
    },
    {
        NULL,
        (gtState *)&SignPass_StateL_1,
        sign_Cube_mesh_vtx_0+128,
        SignPass_tris_2,
    },
    {
        NULL,
        (gtState *)&SignPass_StateL_2,
        sign_Cube_mesh_vtx_0+192,
        SignPass_tris_3,
    },
    {
        NULL,
        (gtState *)&SignPass_StateL_3,
        sign_Cube_mesh_vtx_0+256,
        SignPass_tris_4,
    },
    {
        NULL,
        (gtState *)&SignPass_StateL_4,
        sign_Cube_mesh_vtx_0+320,
        SignPass_tris_5,
    },
    {
        NULL,
        (gtState *)&SignPass_StateL_5,
