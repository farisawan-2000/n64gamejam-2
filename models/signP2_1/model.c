...
#include "n64_defs.h"
#include "gtHelpers.h"
extern Object2639 SignP2_Obj;
Object2639 *SignP2_objp = &SignP2_Obj;
static
...
gtTriN SignP2_tris_0[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {3, 4, 5, 0},
    {6, 7, 8, 0}, {9, 10, 11, 0},
...
gtTriN SignP2_tris_1[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
...
gtTriN SignP2_tris_2[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignP2_tris_3[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignP2_tris_4[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {6, 7, 4, 0},
    {6, 8, 7, 0}, {7, 9, 4, 0},
...
gtTriN SignP2_tris_5[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtTriN SignP2_tris_6[] __attribute__((aligned(8))) = {
    {0, 1, 2, 0}, {0, 2, 3, 0},
    {4, 5, 6, 0}, {4, 6, 7, 0},
    {8, 9, 10, 0}, {8, 10, 11, 0},
    {12, 13, 14, 0}, {12, 14, 15, 0},
...
gtGfx SignP2_GfxList[] = {
    ...
    {
        NULL,
        (gtState *)&SignP2_StateL_0,
        sign_Cube_mesh_vtx_0+64,
        SignP2_tris_1,
    },
    {
        NULL,
        (gtState *)&SignP2_StateL_1,
        sign_Cube_mesh_vtx_0+128,
        SignP2_tris_2,
    },
    {
        NULL,
        (gtState *)&SignP2_StateL_2,
        sign_Cube_mesh_vtx_0+192,
        SignP2_tris_3,
    },
    {
        NULL,
        (gtState *)&SignP2_StateL_3,
        sign_Cube_mesh_vtx_0+256,
        SignP2_tris_4,
    },
    {
        NULL,
        (gtState *)&SignP2_StateL_4,
        sign_Cube_mesh_vtx_0+320,
        SignP2_tris_5,
    },
    {
        NULL,
        (gtState *)&SignP2_StateL_5,
        sign_Cube_mesh_vtx_0+384,
        SignP2_tris_6,
    },
};
OFUN(InGame_SignP2_1Loop);
Object2639 SignP2_Obj = {
    {200, 370, 1000},
    {0, 180, 0},
    {1.0, 1.0, 1.0},

    7, // gfxlist count
    &SignP2_GfxList, // gfxlist name

    MATERIAL_TEXTURE,
    PARAM_PACK(G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 32),
    canvas_P2Instructions_rgba16,
